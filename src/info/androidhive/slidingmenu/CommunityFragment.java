...
import info.androidhive.slidingmenu.HomeFragment.LoadList;
...
public class CommunityFragment extends ListFragment {
    ...
    static final String URL = "https://choccity.herokuapp.com/api/youtube";
...
class LoadList extends AsyncTask<String,String, ArrayList<HashMap<String, String>>> {
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(XMLParser.youtubeLink.get(position)));
